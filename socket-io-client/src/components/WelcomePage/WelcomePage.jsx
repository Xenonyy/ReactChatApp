        ...
        return(
            <section id = "welcome-page">
                <div id = "page-container">
                    <p id = "welcome-text">Welcome to Xenochat!</p>
                    <p id = "welcome-subtext">Please select a username.</p>
                    <div id = "username-container">
                        <p id = "username-text">Username: </p>
                        <input key = "usernameInput" id = "username-input" name = "username-input" minLength = "3" maxLength = "16" onKeyPress = {() => this.hidePageEnter()} autoFocus />
